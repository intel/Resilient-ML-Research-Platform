...
alert(content_type);
            ...
            } else if (content_type.indexOf('myml/') !== -1){
                // special format for redirection
                url = this.options.redirect_url+content_type.substring(5, 100);
            }
            else{
        ...
        set_progress: function(percent){
            ...
            this.$modal_bar.text(percent + '% xxx');
